...
export async function loader({ request }: Route.LoaderArgs) {
  ...
  console.log('Sesion', session.get('userId'));
  ...
  /**
   * En este punto de la clase, todavia no devolvia nada explicitamente, cuando no hay userId
   * agregando este return, corregí el error. 🍺
   */
  //return null;
    ...
    <div className="flex flex-col gap-6">
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
          {/* El name es importantisimo en el Form, para que el campo sea detectado por el FormData*/}
          <Form method='POST' className="p-6 md:p-8" action="/auth/login">
            <div className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                <Button variant="outline" className="w-full" onClick={onAppleLogin}>
